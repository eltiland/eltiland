...
/**
 * Magazine management plugin.
 *
 * @author Aleksey Plotnikov.
 */
public class MagazinePlugin extends EltilandPlugin {

    @Override
    public IModel<String> getTabName() {
        return new ResourceModel("tab.magazine");
    }

    @Override
    public Panel getTabPanel(String panelId, IModel<Workspace> workspaceIModel) {
        return new MagazineManagementPanel(panelId, workspaceIModel);
    }
}
