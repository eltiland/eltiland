 ...
 */
class ELTAjaxPagingNavigationIncrementLink extends PagingNavigationIncrementLink<Void>
	implements
		IAjaxLink
{
	 ...
	 *            increment by
	 */
	public ELTAjaxPagingNavigationIncrementLink(final String id, final IPageable pageable,
		final int increment)
	{
	...
	protected ELTAjaxPagingNavigationBehavior newAjaxPagingNavigationBehavior(IPageable pageable,
		String event)
	{
		return new ELTAjaxPagingNavigationBehavior(this, pageable, "onclick");
	}
