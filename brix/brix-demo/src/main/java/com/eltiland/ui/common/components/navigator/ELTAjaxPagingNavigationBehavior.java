 ...
 */
class ELTAjaxPagingNavigationBehavior extends AjaxEventBehavior
{
    /** For serialization. */
     ...
     */
    public ELTAjaxPagingNavigationBehavior(IAjaxLink owner, IPageable pageable, String event)
    {
        super(event);
        this.owner = owner;
    }
    ...
    protected void onEvent(AjaxRequestTarget target)
    {
        ...
        ELTAjaxPagingNavigator navigator = ((Component)owner).findParent(ELTAjaxPagingNavigator.class);
