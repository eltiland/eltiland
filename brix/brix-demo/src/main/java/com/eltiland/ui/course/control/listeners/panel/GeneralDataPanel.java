 ...
 */
public class GeneralDataPanel extends BaseEltilandPanel<ELTCourseListener> {
    @SpringBean
    private GenericManager genericManager;

    public GeneralDataPanel(String id, IModel<ELTCourseListener> courseListenerIModel) {
