 ...
 */
public final class RussianCaptchaImageResource extends DynamicImageResource
{
	/**
	 ...
	 * Construct.
	 */
	public RussianCaptchaImageResource()
	{
	 ...
	 */
	public RussianCaptchaImageResource(final String challengeId)
	{
	 ...
	 *            The id of the challenge
	 */
	public RussianCaptchaImageResource(final IModel<String> challengeId)
	{
	 ...
	 *            The image's margin
	 */
	public RussianCaptchaImageResource(final IModel<String> challengeId, final int fontSize,
                                       final int margin)
	{
	 ...
	 *            The image's margin
	 */
	public RussianCaptchaImageResource(final String challengeId, final int fontSize, final int margin)
	{
