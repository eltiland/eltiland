 ...
 * @author Matej Knopp
 */
public class ELTTree extends ELTDefaultAbstractTree
{
	 ...
	 *            The component id
	 */
	public ELTTree(final String id)
	{
		super(id);
	}
	 ...
	 *            The tree model
	 */
	public ELTTree(final String id, final IModel<? extends TreeModel> model)
	{
		super(id, model);
	}
	 ...
	 *            The tree model
	 */
	public ELTTree(final String id, final TreeModel model)
	{
		super(id, model);
	}
	 ...
	 */
	protected String renderNode(final ELTTreeNode node)
	{
