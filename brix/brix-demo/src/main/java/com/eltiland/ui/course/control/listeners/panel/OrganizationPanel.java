 ...
 */
public class OrganizationPanel extends BaseEltilandPanel<ELTCourseListener> {
    @SpringBean
    private GenericManager genericManager;

    private boolean allEmpty;

    public OrganizationPanel(String id, IModel<ELTCourseListener> courseListenerIModel) {
