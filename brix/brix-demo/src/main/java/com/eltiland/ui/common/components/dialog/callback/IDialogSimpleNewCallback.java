 ...
 */
public interface IDialogSimpleNewCallback<T> {
    /**
     * @param callback New callback object.
     * @see com.eltiland.ui.common.components.dialog.callback.IDialogSelectCallback
     */
    void setSimpleNewCallback(IDialogActionProcessor<T> callback);
