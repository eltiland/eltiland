 ...
 */
class ELTAjaxPagingNavigationLink extends PagingNavigationLink<Void> implements IAjaxLink
{
	 ...
	 */
	public ELTAjaxPagingNavigationLink(final String id, final IPageable pageable, final int pageNumber)
	{
	 ...
	 */
	protected ELTAjaxPagingNavigationBehavior newAjaxPagingNavigationBehavior(IPageable pageable,
		String event)
	{
		return new ELTAjaxPagingNavigationBehavior(this, pageable, event);
	}
