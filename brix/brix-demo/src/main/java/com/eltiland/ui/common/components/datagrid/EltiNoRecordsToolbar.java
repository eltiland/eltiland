 ...
 * @author Matej Knopp
 */
public class EltiNoRecordsToolbar<D extends IDataSource<T>, T> extends AbstractToolbar<D, T>
{
	 ...
	 */
	public EltiNoRecordsToolbar(final EltiDataGrid<D, T> table)
	{
	 ...
	 */
	public EltiNoRecordsToolbar(final EltiDataGrid<D, T> grid, IModel<String> messageModel)
	{
		super(grid, null);
	...
	/**
	 * Returns the {@link com.inmethod.grid.datagrid.DataGrid} instance this toolbar belongs to.
	 *
	 * @return {@link com.inmethod.grid.datagrid.DataGrid} instance this toolbar belongs to.
	 */
