 ...
 * 
 */
public class EltiNavigatorLabel extends Label
{
	 ...
	 *            pageable view
	 */
	public <D extends IDataSource<T>, T> EltiNavigatorLabel(final String id, final EltiDataGrid<D, T> table)
	{
		super(id);
	...
	{
		private static final long serialVersionUID = 1L;
		private final EltiDataGrid<D, T> table;
		 ...
		 * @param table
		 */
		public LabelModelObject(EltiDataGrid<D, T> table)
		{
			this.table = table;
		}
