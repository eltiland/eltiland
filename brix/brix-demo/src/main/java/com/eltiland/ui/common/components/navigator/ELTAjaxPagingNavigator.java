 ...
 */
package com.eltiland.ui.common.components.navigator;
 ...
 */
public class ELTAjaxPagingNavigator extends PagingNavigator
{
	 ...
	 */
	public ELTAjaxPagingNavigator(final String id, final IPageable pageable)
	{
	...
	{
		return new ELTAjaxPagingNavigationIncrementLink(id, pageable, increment);
	}
	...
	{
		return new ELTAjaxPagingNavigationLink(id, pageable, pageNumber);
	}

	/**
	 * @see org.apache.wicket.markup.html.navigation.paging.PagingNavigator#newNavigation(String,
	...
	protected PagingNavigation newNavigation(final String id, final IPageable pageable,
		final IPagingLabelProvider labelProvider)
	{
		return new ELTAjaxPagingNavigation(id, pageable, labelProvider);
	}
