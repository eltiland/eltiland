 ...
 */
class ELTAjaxPagingNavigation extends PagingNavigation
{
	 ...
	 */
	public ELTAjaxPagingNavigation(final String id, final IPageable pageable)
	{
	...
	{
		return new ELTAjaxPagingNavigationLink(id, pageable, pageIndex);
	}
}
