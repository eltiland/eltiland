...
function mcImgSlider(k) {
    ...
    }, Lb = document, U = window.requestAnimationFrame, db = window.cancelAnimationFrame, jb = ["webkit", "ms", "o"], cb = 0; cb < jb[d] && !U; ++cb) {
    ...
    var c = "style", y = "display", G = "visibility", j = "width", z = "height", Y = "top", P = "background", r = "undefined", x = "marginLeft", w = "appendChild", q = "parentNode", o = "nodeName", Q = "innerHTML", X = "offsetWidth", D = setTimeout, L = clearTimeout, F = "indexOf", N = "setAttribute", ib = "removeChild", E = function () {
        ...
        return b
    }, bb = rb() < 9, ub = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent), M = function (a, b) {
        if (a) {
            a.o = b;
    ...
    }, zb = ["$1$2$3", "$1$2$3", "$1$24", "$1$23", "$1$22"], sb = function () {
        if (b.b != 2) {
            b.b = 1;
            L(s);
            s = null
